package pepsico.entry.servers;

import pepsico.entry.servers.employee.EmployeeServer;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        } else if (serverName.equals("employee")) {
            EmployeeServer.main(args);
        } /*else if (serverName.equals("hcm")) {
            HcmServer.main(args);
        } */else {
